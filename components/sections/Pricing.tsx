...
export function Pricing() {
  return (
    <section
      id="pricing"
      className="py-24 px-4 bg-gradient-to-b from-white to-[#FAFAFA]"
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-lg text-[#707070] max-w-2xl mx-auto">
            Choisissez le plan qui vous convient. Changez ou annulez à tout
            moment.
          </p>
        </div>
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <div className="mb-8">
                ...
                {plan.trial && (
                  <div className="mt-3 inline-block px-3 py-1 bg-gradient-to-r from-[#A8E063]/10 to-[#7BC041]/10 rounded-full border border-[#A8E063]/30">
                    <span className="text-sm font-semibold text-[#7BC041]">
        ...
        <div className="mt-12 text-center">
          <p className="text-[#707070]">
            Tous les plans incluent une garantie satisfait ou remboursé de 14
            jours
          </p>
        </div>
      </div>
